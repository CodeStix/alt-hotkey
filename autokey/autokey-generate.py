...
createHotKey("<alt>+<space>", "<ctrl>+<space>")
createHotKey("<alt_gr>+<space>", "<ctrl>+<space>")

createHotKey("<alt>+<shift>+x", "<ctrl>+<shift>+x")
createHotKey("<alt>+x", "<ctrl>+x")
createHotKey("<alt_gr>+<shift>+x", "<ctrl>+<shift>+x")
createHotKey("<alt_gr>+x", "<ctrl>+x")
createHotKey("<alt>+<shift>+c", "<ctrl>+<shift>+c")
createHotKey("<alt>+c", "<ctrl>+c")
createHotKey("<alt_gr>+<shift>+c", "<ctrl>+<shift>+c")
createHotKey("<alt_gr>+c", "<ctrl>+c")
createHotKey("<alt>+<shift>+v", "<ctrl>+<shift>+v")
createHotKey("<alt>+v", "<ctrl>+v")
createHotKey("<alt_gr>+<shift>+v", "<ctrl>+<shift>+v")
createHotKey("<alt_gr>+v", "<ctrl>+v")

createHotKey("<alt_gr>+j", "<ctrl>+j")
createHotKey("<alt_gr>+p", "<ctrl>+p")
createHotKey("<alt_gr>+<shift>+p", "<ctrl>+<shift>+p")

createHotKey("<alt>+.", "<ctrl>+.")
createHotKey("<alt>+/", "<ctrl>+/")
createHotKey("<alt>+a", "<ctrl>+a")
createHotKey("<alt>+e", "<escape>")
createHotKey("<alt>+b", "<ctrl>+s")
createHotKey("<alt>+f", "<ctrl>+f")
createHotKey("<alt>+<shift>+f", "<ctrl>+<shift>+f")
createHotKey("<alt>+p", "<ctrl>+p")
createHotKey("<alt>+<shift>+p", "<ctrl>+<shift>+p")
...
createHotKey("<alt>+<shift>+<backspace>", "<ctrl>+<right><backspace>")
